    ...
    <body>
        ...
        <h1 style="margin-left: 50px;"> <a href="logout.php">Log out</a></h1>
            ...
            <div class="menu_select">
                ...
                <a href="book-court-coach.php"><div class="row1"><i class='bx bx-book'></i><p>Book Court</p></div></a>
                <a href="my_bookings.php"><div class="row1"><i class='bx bxs-calendar-exclamation' ></i><p>My Bookings</p></div></a>
