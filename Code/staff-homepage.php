    ...
    <body>
        ...
        <h1 style="margin-left: 50px;"> <a href="logout.php">Log out</a></h1>
            ...
            <div class="menu_select">
                ...
                <a href=""><div class="row1"><i class='bx bx-book'></i><p>Manage Bookings</p></div></a>
                <a href=""><div class="row2"><i class='bx bxs-calendar-exclamation' ></i><p>Manage Sessions</p></div></a>
